...
class TestFilterCarDetections:
    ...
    def test_filter_car_detections_with_fixture(
        self,
        filter_car_detections,
        expected_formatted_detections,
        expected_car_detections,
    ):
        """Test filtering using the mock detection fixtures."""
        filtered_detections = filter_car_detections.filter_car_detections(
            expected_formatted_detections
        )
